...
var mainPage = '/company/personal/user/41/tasks/',
	...
	typesOfTasks = ['Оптимизация', 'Контент+Доп.', 'Модернизация', 'Доп. оплата (Конт)', 'Доп. оплата (Модерн)', 'Кон. реклама', 'Разработка сайта', 'Другое', 'Адаптивная верстка', 'Многоканальность'],
